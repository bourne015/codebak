...
{
	int ret;
/*set the io as input mod,and get the stat*/
...
void led_exit(void)
{
/*release io map and io region*/
	led_release();

/*release and del char device*/
